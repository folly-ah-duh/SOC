...
{
    class SphereShape : Fox2EntityClass
    {
        private string name;
        private Fox2EntityClass dataSet, parent, parameters;

        public SphereShape(string _name, Fox2EntityClass _dataSet, Fox2EntityClass _parent)
        {
            name = _name;
            dataSet = _dataSet;
            parent = _parent;
        ...
        <entity class=""SphereShape"" classVersion=""0"" addr=""{GetHexAddress()}"" unknown1=""256"" unknown2=""9784902"">
          <staticProperties>
