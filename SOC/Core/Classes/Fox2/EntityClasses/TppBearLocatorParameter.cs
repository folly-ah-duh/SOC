...
{
    class TppBearLocatorParameter : Fox2EntityClass
    {
        private Fox2EntityClass owner;
        private string animalCount;

        public TppBearLocatorParameter(Fox2EntityClass _owner, string count)
        {
        ...
        <entity class=""TppBearLocatorParameter"" classVersion=""0"" addr=""{GetHexAddress()}"" unknown1=""40"" unknown2=""8422629"">
          <staticProperties>
