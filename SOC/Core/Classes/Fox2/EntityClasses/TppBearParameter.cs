...
{
    class TppBearParameter : Fox2EntityClass
    {
        private Fox2EntityClass owner;
        private string partsFile, motionGraphFile, mtarFile, fovaFile;

        public TppBearParameter(Fox2EntityClass _owner, string animalName)
        {
        ...
        <entity class=""TppBearParameter"" classVersion=""1"" addr=""{GetHexAddress()}"" unknown1=""120"" unknown2=""8422681"">
          <staticProperties>
