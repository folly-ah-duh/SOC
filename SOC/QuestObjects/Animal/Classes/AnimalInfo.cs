namespace SOC.QuestObjects.Animal
{
    public static class AnimalInfo
    {
        ...
        public static void getAnimalPaths(string animalName, out string partsPath, out string mog, out string mtar,  out string fv2Path)
        {
            partsPath = ""; mog = ""; mtar = ""; fv2Path = "";

            switch (animalName)
            {
                case "Sheep":
                    partsPath = "/Assets/tpp/parts/chara/kkl/kkl0_main0_def_v00.parts";
                    mog = "/Assets/tpp/motion/motion_graph/goat/Goat_layers.mog";
                    mtar = "/Assets/tpp/motion/mtar/goat/Goat_layers.mtar";
                ...
                case "Donkey":
                    ...
                    mog = "/Assets/tpp/motion/motion_graph/zebra/TppZebra_layers.mog";
                    mtar = "/Assets/tpp/motion/mtar/zebra/Zebra_layers.mtar";
                    fv2Path = "";
                    break;
                case "Zebra":
